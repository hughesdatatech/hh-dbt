{%- macro build_hardcoded_multiplier_join(hcm_field_name, main_alias, build_signups_join=true, build_validity_join=true, hcm_alias_override='hcm') -%}
        left join {{ ref("ref_forecast_hard_coded_multiplier_scd") }} as {{ hcm_alias_override }}
